  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      <div className="text-center max-w-2xl mx-auto mb-8 md:mb-12">
        <h1 className="text-3xl md:text-4xl font-bold text-white mb-4">Weekly Skill Challenges</h1>
        <p className="text-gray-400 text-base md:text-lg">Compete with the community, earn reputation, and unlock exclusive mentor discounts.</p>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        {/* Featured Challenge (Hero) */}
        <div className="lg:col-span-2 bg-gradient-to-br from-neon-red/20 to-transparent border border-neon-red/50 rounded-3xl p-6 md:p-8 relative overflow-hidden group">
          ...
          <h2 className="text-2xl md:text-4xl font-bold text-white mb-4 max-w-lg">
          ...
          <div className="flex flex-wrap gap-4 md:gap-6 mb-8">
            <div className="bg-black/40 px-4 py-2 rounded-lg border border-gray-700 flex items-center gap-2 text-sm">
          ...
          <button className="w-full md:w-auto bg-neon-red text-black font-bold px-8 py-4 rounded-xl hover:bg-white hover:scale-105 transition-all shadow-[0_0_20px_#FF5E5E]">
            Accept Challenge
          </button>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {challenges.map((challenge) => (
          <div key={challenge.id} className="bg-dark-card border border-dark-border rounded-2xl overflow-hidden hover:border-gray-600 transition-all group flex flex-col">
            ...
            <div className="p-6 flex-1 flex flex-col">
              ...
              <div className="flex justify-between items-center text-xs text-gray-500 font-mono mb-6 mt-auto">
